...
<head>
    ...
    <title>YouTube Downloader - X-INCRASH</title>
    ...
    <header class="header" id="header">
        <nav class="nav-container">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="https://wa.me/6287756012848" class="nav-link">WhatsApp</a></li>
                <li><a href="https://t.me/Danzriel" class="nav-link">Telegram</a></li>
    ...
    <script>
        ...
        async function searchYoutube() {
            ...
            try {
                ...
                logMessage(`🔍 Mencari video: "${query}"`, 'info');
                ...
                if (data.success) {
                    ...
                    logMessage(`✅ Ditemukan ${data.results.length} hasil pencarian`, 'success');
                } else {
                ...
                logMessage(`❌ Gagal mencari: ${err.message}`, 'error');
            }
        }
        ...
        async function playYoutubeMusic(data) {
            ...
            logMessage(`🎵 Memproses audio: "${data.title}"`, 'info');
            ...
            try {
                ...
                if (result.success) {
                    ...
                    logMessage(`✅ Audio siap: "${data.title}"`, 'success');
                    updateStats('success');
                } else {
                ...
                logMessage(`❌ Gagal memutar: ${err.message}`, 'error');
            }
        }
        ...
        function toggleYoutubePlayPause() {
            ...
            if (currentYoutubeAudio.paused) {
                ...
                logMessage(`▶️ Memutar audio: "${currentYoutubeData.title}"`, 'info');
            } else {
                currentYoutubeAudio.pause();
                icon.className = 'fas fa-play';
                btn.innerHTML = '<i class="fas fa-play"></i> Play Audio';
                logMessage(`⏸️ Menjeda audio: "${currentYoutubeData.title}"`, 'info');
            }
        }
        ...
        function downloadYoutubeMusic() {
            ...
            logMessage(`📥 Mengunduh: "${currentYoutubeData.title}"`, 'success');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Log welcome message
            setTimeout(() => {
                logMessage('🚀 YouTube Downloader siap digunakan', 'success');
                logMessage('🔍 Masukkan URL atau judul video YouTube untuk memulai', 'info');
            }, 500);
        });
    </script>
</body>
